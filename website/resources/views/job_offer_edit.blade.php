...
<div class="main">
    <div class="content_field">
        ...
        @csrf <!-- {{ csrf_field() }} -->
            <input type="hidden" name="id" readonly value={{ $job_offer->id }}>
            <input class="input_field" type="text" name="industry" value={{ $job_offer->industry }}>
            <input class="input_field" type="text" name="experience_level" value={{ $job_offer->experience_level }}>
            <input class="input_field" type="text" name="employement_type" value={{ $job_offer->employement_type }}>
            <input class="button" type="submit" value="apply">
        </form>
        <a href="http://127.0.0.1:8000/job_offer"><button class="custom_button">Back to Category</button></a>
    </div>
</div>
